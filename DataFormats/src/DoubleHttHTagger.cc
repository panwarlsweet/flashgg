...
void DoubleHttHTagger::initializeSelectionThresholds(){//FIXME do this configurable
...
void DoubleHttHTagger::initializeMVAVariables(std::string weightFile, std::vector<string> varvec){ 
    std::vector<string> defaultVariables = {"sumEt", "dPhi1", "dPhi2", "PhoJetMinDr", "njets", 
        "Xtt0", "Xtt1", "fabs_CosThetaStar_CS", "fabs_CosTheta_bb", 
        "pte1", "pte2", "ptmu1", "ptmu2","ptdipho","MET",
        "etae1", "etae2", "etamu1", "etamu2","etadipho",
        "phie1", "phie2", "phimu1", "phimu2","phidipho","phiMET"};
...
void DoubleHttHTagger::setupMVA(std::string File, std::vector<std::string> inVars){
//    TMVAReady = 1;
...
float DoubleHttHTagger::mvaDiscriminants(std::map<std::string,float> params)
{
