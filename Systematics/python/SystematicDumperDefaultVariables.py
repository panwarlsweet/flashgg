...
minimalNonSignalVariables = ["CMS_hgg_mass[160,100,180]:=diPhoton().mass","CMS_hjj_mass[120,70,190]:=dijet().M()"]#,"centralObjectWeight[1,-999999.,999999.] := centralWeight"]
...
systematicVariables=["CMS_hgg_mass[160,100,180]:=diPhoton().mass","CMS_hjj_mass[120,70,190]:=dijet().M()"]#,"centralObjectWeight[1,-999999.,999999.] := centralWeight"]
