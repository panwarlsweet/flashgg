...
#             "Mjj := dijet().M()"
        ...
        if self.customize.doBJetRegression : variables +=[
                ...
                "reg_reco_mjj := reg_reco_mjj()",
                "reg_recoJet_1_pt := reg_recoJet_1_pt()",
                "reg_recoJet_1_eta := reg_recoJet_1_eta()",
                "reg_recoJet_1_phi := reg_recoJet_1_phi()",
                "reg_recoJet_1_e := reg_recoJet_1_e()",
                "reg_recoJet_1_mass := reg_recoJet_1_mass()",
                "reg_recoJet_1_DeepCSV := reg_recoJet_1_DeepCSV()",
                "reg_recoJet_1_DeepJet := reg_recoJet_1_DeepJet()",
                "reg_recoJet_2_pt := reg_recoJet_2_pt()",
                "reg_recoJet_2_eta := reg_recoJet_2_eta()",
                "reg_recoJet_2_phi := reg_recoJet_2_phi()",
                "reg_recoJet_2_e := reg_recoJet_2_e()",
                "reg_recoJet_2_mass := reg_recoJet_2_mass()",
                "reg_recoJet_2_DeepCSV := reg_recoJet_2_DeepCSV()",
                "reg_recoJet_2_DeepJet := reg_recoJet_2_DeepJet()",
                "reg_MET := reg_MET()",
                "reg_MET_phi := reg_MET_phi()",
                "reg_reco_Mbbgg := reg_reco_Mbbgg()",
                "nGenJets := nGenJets()",
                "nbGenJetsNu := nbGenJetsNu()",
                "nNus := nNus()",
        ]
